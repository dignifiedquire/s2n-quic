...
use crate::{aead::Aead, header_key::HeaderKey, good_internal_hkdf, AuditInternalPrk, GoodPrk, iv, good_internal_aead};
use core::fmt;
use s2n_quic_core::{
    assume,
...
macro_rules! impl_cipher_suite {
    (
        ...
        mod $lower {
            ...
            pub const NONCE_LEN: usize = good_internal_aead::NONCE_LEN;
...
impl_cipher_suite!(
    ...
    good_internal_aead::AES_256_GCM,
    256 / 8, // 256-bit key
    good_internal_aead::quic::AES_256,
    label::QUIC_KEY_32,
    label::QUIC_IV_12,
    label::QUIC_HP_32,
    label::QUIC_KU_48,
...
impl_cipher_suite!(
    ...
    good_internal_aead::CHACHA20_POLY1305,
    256 / 8, // 256-bit key
    good_internal_aead::quic::CHACHA20,
    label::QUIC_KEY_32,
    label::QUIC_IV_12,
    label::QUIC_HP_32,
    label::QUIC_KU_32,
...
impl_cipher_suite!(
    ...
    aes128_gcm,
    good_internal_hkdf::HKDF_SHA256,
    good_internal_aead::AES_128_GCM,
    128 / 8, // 128-bit key
    good_internal_aead::quic::AES_128,
    label::QUIC_KEY_16,
    label::QUIC_IV_12,
    label::QUIC_HP_16,
    label::QUIC_KU_32,
