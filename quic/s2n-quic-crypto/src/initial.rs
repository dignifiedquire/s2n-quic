...
use crate::{cipher_suite::TLS_AES_128_GCM_SHA256 as CipherSuite, header_key::HeaderKeyPair, audit_internal_hkdf};
use s2n_quic_core::{
    crypto::{
        self,
...
lazy_static::lazy_static! {
    ...
    static ref INITIAL_SIGNING_KEY: audit_internal_hkdf::Salt = audit_internal_hkdf::Salt::new(audit_internal_hkdf::HKDF_SHA256, &INITIAL_SALT);
}
